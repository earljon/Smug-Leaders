...
#import "PH_LeadersAppDelegate.h"

@implementation PH_LeadersAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString *targetPath = [[paths objectAtIndex:0]
                            stringByAppendingPathComponent:@"ph_leaders.db"];
	...
	if([fileMgr fileExistsAtPath:targetPath]) {
        ...
        NSString *sourcePath = [[NSBundle mainBundle] pathForResource:@"ph_leaders" ofType:@"db"];
        [fileMgr copyItemAtPath:sourcePath toPath:targetPath error:nil]; 
        NSLog(@"Copied DB named %@ from bundle path to documents directory.", @"ph_leaders.db");
    }
